...
const localImagePost = {
  ...
  creator: {
    id: 7,
    name: "alice",
    avatar: "https://lemmy.world/u/alice.png",
  ...
  community: {
    ...
    name: "technology",
    title: "Technology",
    icon: "https://lemmy.world/c/tech.png",
...
const remoteLinkPost = {
  ...
  creator: {
    id: 99,
    name: "bob",
    actor_id: "https://sh.itjust.works/u/bob",
    local: false,
    bot_account: false,
  },
  community: {
  ...
  comments: [
    {
      comment: {
        ...
        creator_id: 7,
        post_id: 1001,
        content: "OP top comment",
        path: "0.10",
        published: "2024-05-01T12:05:00",
        ap_id: "https://lemmy.world/comment/10",
        local: true,
        distinguished: false,
      },
      creator: {
    ...
    },
    {
      comment: {
        ...
        content: "A reply",
        path: "0.10.11",
        published: "2024-05-01T12:06:00",
        ap_id: "https://lemmy.world/comment/11",
        local: true,
        distinguished: false,
      },
      creator: {
    ...
    },
    {
      comment: {
        ...
        creator_id: 99,
        post_id: 1001,
        content: "Remote commenter",
        path: "0.12",
        published: "2024-05-01T12:10:00",
        ap_id: "https://beehaw.org/comment/12",
        local: false,
        distinguished: false,
      },
      creator: {
        id: 99,
        name: "dave",
        actor_id: "https://beehaw.org/u/dave",
        local: false,
        bot_account: false,
      },
      post: { id: 1001, creator_id: 7 },
